...
All three mutations require global tenant permissions (`SUPER_ADMIN` by default; extendable via [Tenant ACL](/reference/engine/schema/acl.md#tenant-permissions)) and are recorded in the [audit log](./audit-log.md).
