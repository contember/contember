			...
			items: [
				...
				},
				{
					...
					items: [
						...
						'reference/engine/tenant/sign-up',
						'reference/engine/tenant/sign-in',
						'reference/engine/tenant/sessions',
						'reference/engine/tenant/passwordless',
						'reference/engine/tenant/idp',
						'reference/engine/tenant/password-reset',
						'reference/engine/tenant/two-factor',
						'reference/engine/tenant/profile',
