...
- [Yarn](https://yarnpkg.com/) or [NPM 7](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) or other package manager of your choice.
...
```bash
npx "@contember/create@next" quickstart
```
