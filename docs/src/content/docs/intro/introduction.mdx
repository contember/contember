...
import DocsCard from '../../../components/DocsCard.tsx'
import DocsCards from '../../../components/DocsCards.tsx'
...
| Feature | Description |
|---|---|
| **[Declarative role-based access control](/reference/engine/schema/acl)** | Build secure apps with numerous roles and granular data access controls. This helps you create secure apps with complex access requirements. |
| **[Instant GraphQL API](/reference/engine/content/overview)** | Automatically get high-performant, role-specific GraphQL APIs, accelerating feature development and allowing easy data utilization with any framework or language. |
...
| **[Built-in authentication and authorization](/reference/engine/tenant/overview)** | Skip integrating third-party auth solutions and spend more time developing. |
| **[Automatic database migrations](/reference/engine/migrations/overview)** | Database schema changes are handled smoothly, reducing update risks. |
...
If you have questions about anything related to Contember, you're always welcome to ask our us on [Github Discussions](https://github.com/orgs/contember/discussions) or [Twitter](https://twitter.com/contember).
