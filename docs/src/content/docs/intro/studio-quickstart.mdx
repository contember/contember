...
Your project is already deployed to Contember Cloud. Therefore all you need to do is to setup a Github Action (or similar if you're not using Github). Take a look at our guide on how to [deploy your project to Contember Cloud](/guides/deploy-contember)
