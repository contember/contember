...
If you have chosen to execute migration, you are done for now. If you haven't, you can check created `.json` file and [modify migration](/reference/engine/migrations/advanced/writing-schema-migrations) file manually describing the change more precisely.
