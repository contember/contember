...
See [anti-abuse](/reference/engine/tenant/anti-abuse) for the broader picture of how password policy interacts with rate limits, captcha, and enumeration protection.
