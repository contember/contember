...
| `canViewConfiguration` | `system:viewConfig` | `configuration`, `authPolicies`, `identityProviders`, `mailTemplates` |
| `canManageConfiguration` | `system:configure` | `configure` and the policy / IdP / mail-template mutations |
