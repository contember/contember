...
- [Data binding](/reference/interface/data-binding/overview) which allows you to easily connect your administration interface to the data stored in your application.
