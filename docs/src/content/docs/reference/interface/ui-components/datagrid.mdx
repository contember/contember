...
- Integrate seamlessly with the [Contember interface binding](/reference/interface/data-binding/overview) to render fields and relations.
...
- **If you need** total flexibility or a highly custom layout, revisit the [Headless Data View docs](/reference/interface/headless-components/dataview).
