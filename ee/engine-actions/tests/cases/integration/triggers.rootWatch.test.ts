		...
		expectSystemDatabase: {
			actions_event: [{
				payload: {
					...
					operation: 'watch',
					selection: { id: '123e4567-e89b-12d3-1111-000000000003', title: 'Hello world' },
				},
				log: [],
			}, {
				payload: {
					...
					trigger: 'article_watch',
					operation: 'watch',
					selection: { id: '123e4567-e89b-12d3-1111-000000000003', title: 'Hi!' },
				},
				log: [],
			}],
		},
	...
	await executeDbTest({
		...
		expectSystemDatabase: {
			actions_event: [{
				...
				transaction_id: '123e4567-e89b-12d3-1111-000000000002',
				num_retries: 0,
				state: 'created',
				stage_id: '123e4567-e89b-12d3-1111-000000000001',
				schema_id: 1,
