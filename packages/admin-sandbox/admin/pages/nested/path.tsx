import { Section, SectionTabs, SectionTabsProvider, SelectFieldInner, Text } from '@contember/admin'
	...
	return (
		<SectionTabsProvider>
			...
			<SlotSources.SidebarRightHeader>
				<Text as="p"><small>Hello Contember world from the sidebar!</small></Text>
			</SlotSources.SidebarRightHeader>
			...
			<SlotSources.SidebarRightBody>
				<Text as="p">This should render is sidebar right body!</Text>
			</SlotSources.SidebarRightBody>

			<SlotSources.SidebarRightFooter>
				<Text as="p">I am in sidebarRight footer!</Text>
			</SlotSources.SidebarRightFooter>
		</SectionTabsProvider>
	)
}
