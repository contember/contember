import type { DataGridCellsDictionary, FieldViewDictionary, DataGridDictionary, RepeaterDictionary } from './components'
...
export type AdminDictionary = DataGridCellsDictionary & DataGridDictionary & FieldViewDictionary & RepeaterDictionary
