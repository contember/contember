...
const ProjectSecretVariable: GQLVariableType<{ key: string; value: string }, false> = {
	graphQlType: 'ProjectSecret',
	required: false,
}
...
export const useCreateProject = () => {
	return useSingleTenantMutation<
		...
		typeof createProjectVariables
	>(CREATE_PROJECT_MUTATION, createProjectVariables)
}
