import type { BatchUpdatesOptions, EntityAccessor, ErrorAccessor } from '@contember/binding-common'
import { ServerId, UnpersistedEntityDummyId } from '@contember/binding-common'
import { BindingError } from '@contember/binding-common'
import { EntityFieldMarkersContainer, HasOneRelationMarker } from '@contember/binding-common'
import type { FieldName } from '@contember/binding-common'
import { assertNever } from '@contember/binding-common'
import type { AccessorErrorManager } from '../AccessorErrorManager.js'
import type { EventManager } from '../EventManager.js'
import { LocalizedBindingError } from '@contember/binding-common'
import { MarkerComparator } from '@contember/binding-common'
import { EntityListState, EntityRealmState, EntityRealmStateStub, getEntityMarker, StateIterator } from '../state/index.js'
