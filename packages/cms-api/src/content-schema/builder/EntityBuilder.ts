...
class EntityBuilder
{
  ...
  constructor(options: Partial<EntityBuilder.EntityOptions>, fields: FieldBuilder.Map = {}, addEntity: AddEntityCallback)
  {
  ...
  {
    return new EntityBuilder({...this.options, unique: [...(this.options.unique || []), {fields: fields}]}, this.fields, this.addEntity)
  }
  ...
  oneHasOne(name: string, configurator: EntityBuilder.FieldConfigurator<OneHasOneBuilder, OneHasOneBuilder.Options>): EntityBuilder
  {
    ...
    return new EntityBuilder(this.options, {...this.fields, [name]: {type: FieldBuilder.Type.OneHasOne, options}}, this.addEntity)
  }
