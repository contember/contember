...
export type SubQueryLiteralFactory<Builder extends QueryBuilder = QueryBuilder> = (
	context: Compiler.Context,
	preprocessor?: (query: SelectBuilder | Builder) => QueryBuilder,
) => Literal
...
export function createSubQueryLiteralFactory<Builder extends QueryBuilder = QueryBuilder>(
	expr: SubQueryExpression<Builder>,
): SubQueryLiteralFactory<Builder> {
