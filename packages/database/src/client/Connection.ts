...
namespace Connection {
	...
	export interface ConnectionWithScope<Sub> {
		scope<Result>(
	...
	export interface ConnectionLike extends Transactional, Queryable, ConnectionWithScope<ConnectionLike> {
	}
	...
	export interface TransactionLike extends Transactional, Queryable, ConnectionWithScope<TransactionLike> {
