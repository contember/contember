...
export async function* asyncIterableTransaction<T, TReturn = any, TNext = undefined>(
	db: Client,
	cb: (db2: Client<Connection.TransactionLike>) => AsyncIterableX<T, TReturn, TNext>,
): AsyncIterableX<T, TReturn, TNext> {
