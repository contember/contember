			...
			actions_event: [{
				payload: {
					...
					events: [{
						...
						entity: 'Article',
						relation: 'tags',
						inverseId: '123e4567-e89b-12d3-a456-000000000004',
					...
					selection: {
						id: '123e4567-e89b-12d3-a456-000000000003',
						tags: [{ id: '123e4567-e89b-12d3-a456-000000000004', name: 'graphql' }],
						title: 'Hello world',
					},
				},
			}, {
		...
		expectSystemDatabase: {
			actions_event: [{
				payload: {
					...
					trigger: 'article_watch',
					operation: 'watch',
					selection: { id: '123e4567-e89b-12d3-a456-000000000003', tags: [], title: 'Hello world' },
				},
			}, {
				payload: {
					id: '123e4567-e89b-12d3-a456-000000000003',
					...
					events: [{
						...
						entity: 'Article',
						relation: 'tags',
						inverseId: '123e4567-e89b-12d3-a456-000000000006',
						operation: 'junction_connect',
					}],
					trigger: 'article_watch',
					operation: 'watch',
					selection: {
						id: '123e4567-e89b-12d3-a456-000000000003',
						tags: [{ id: '123e4567-e89b-12d3-a456-000000000006', name: 'graphql' }],
						title: 'Hello world',
					},
				},
			}],
