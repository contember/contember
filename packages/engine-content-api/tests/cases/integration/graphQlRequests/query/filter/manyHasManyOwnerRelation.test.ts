		...
		executes: [
			{
				sql: SQL`
					...
					where exists (select 1
						from "public"."post_categories" as "root_categories_junction_"
						inner join  "public"."category" as "root_categories" on  "root_categories_junction_"."category_id" = "root_categories"."id"
						where "root_"."id" = "root_categories_junction_"."post_id" and exists (select 1
							from "public"."category_tags_but_with_very_very_very_long_name_so_it_reaches_postgresql_alias_length_limit" as "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_2"
							inner join  "public"."tag" as "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_1" on  "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_2"."tag_id" = "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_1"."id"
							where "root_categories"."id" = "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_2"."category_id" and "root_categoriestagsButWithVeryVeryVeryLongNameSoItReachesPost_1"."name" = ?))
				`,
				parameters: ['Stuff'],
				response: {
					rows: [
