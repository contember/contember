...
export type DbColumnSchema =
	| {
		...
		nullable?: boolean
		list?: boolean
		type: Exclude<Model.ColumnType, Model.ColumnType.Enum | Model.ColumnType.Json | Model.ColumnType.Int>
	}
	| { name: string; nullable?: boolean; list?: boolean; type: Model.ColumnType.Int; sequence?: boolean }
	| { name: string; nullable?: boolean; list?: boolean; type: Model.ColumnType.Json; schema?: Typesafe.Type }
	| { name: string; nullable?: boolean; list?: boolean; type: Model.ColumnType.Enum; values: readonly string[] }
