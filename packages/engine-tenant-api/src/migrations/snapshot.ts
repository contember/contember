...
CREATE TABLE "config" (
    ...
    "rate_limit_password_reset_mail_per_email_limit" integer DEFAULT 5 NOT NULL,
    "rate_limit_password_reset_mail_per_email_window" interval DEFAULT '01:00:00'::interval NOT NULL,
    "rate_limit_passwordless_init_mail_per_email_limit" integer DEFAULT 5 NOT NULL,
    "rate_limit_passwordless_init_mail_per_email_window" interval DEFAULT '01:00:00'::interval NOT NULL,
