...
namespace PermissionActions {
	...
	// meta is optional only so a grant can be registered without one — `Permissions.allow`
	// keys on resource + privilege and never reads it. Every check site passes it.
