...
export type ConfigRow = {
	...
	rate_limit_password_reset_mail_per_email_limit: number
	rate_limit_password_reset_mail_per_email_window: IPostgresInterval
	rate_limit_passwordless_init_mail_per_email_limit: number
