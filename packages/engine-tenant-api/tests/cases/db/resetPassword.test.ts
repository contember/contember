import { signUpMutation } from '../integration/mocked/gql/signUp'
import { createResetPasswordRequestMutation } from '../integration/mocked/gql/createResetPasswordRequest'
import { TenantRole } from '../../../src/model/authorization'
import { resetPasswordMutation } from '../integration/mocked/gql/resetPassword'
import { signInMutation } from '../integration/mocked/gql/signIn'
