		...
		<div>
			<Menu>
				...
				<MenuItem icon={<UploadIcon size={16} />} label="Upload">
					...
					<MenuItem icon={line} label="Image w/o meta upload" to="upload/imageTrivial" />
					...
					<MenuItem icon={line} label="Image repeate uploadr" to="upload/imageList" />
				</MenuItem>
				...
				<MenuItem icon={<PencilIcon size={16} />} label="Custom components">
					<MenuItem icon={line} label="Custom Input" to="custom/input" />
					<MenuItem icon={line} label="Folder structure" to="folders" />
					<MenuItem icon={line} label="Folder dataview" to="folders/dataview" />
					<MenuItem icon={line} label="Folder combo" to="folders/dialogGrid" />
				</MenuItem>
				<MenuItem icon={<DatabaseIcon size={16} />} label="Auto CRUD" to="auto/index" />
				<MenuItem icon={<LoaderIcon size={16} />} label="Extend tree">
					<MenuItem icon={line} label="Entity subtree" to="extendTreeSingle" />
					<MenuItem icon={line} label="Entity list subtree" to="extendTreeMany" />
				</MenuItem>
