...
import { Component, EnvironmentMiddleware, Field, Variable } from '@contember/interface'
...
export default () => (
	<GenericPage
		title="Articles"
		actions={<>
			<StyledLink to="form/articleCreate">Create article</StyledLink>
			<StyledLink to="form/tagCreate">Create tag</StyledLink>
			<StyledLink to="form/authorCreate">Create author</StyledLink>
		</>}
	>
		<DefaultDataGrid entities="FormArticle">
			<DataGridTextColumn header="Internal name" field="internalName">
				<StyledLink to="form/articleEdit(id: $entity.id)">
		...
		<DefaultDataGrid entities="FormTag">
			<DataGridTextColumn header="Name" field="name">
				<StyledLink to="form/tagEdit(id: $entity.id)">
					<Field field="name" />
				</StyledLink>
			</DataGridTextColumn>
		</DefaultDataGrid>
		...
		<DefaultDataGrid entities="FormAuthor">
			<DataGridTextColumn header="Name" field="name">
				<StyledLink to="form/authorEdit(id: $entity.id)">
					<Field field="name" />
				</StyledLink>
			</DataGridTextColumn>
		</DefaultDataGrid>
