...
export class IncrementalMarkerBuilder {
	public static build(
		markers: (EntityFieldMarker | EntityFieldMarkersContainer | EntityFieldsWithHoistablesMarker)[],
	): EntityFieldsWithHoistablesMarker | EntityFieldMarkersContainer {
		return markers.reduce<EntityFieldsWithHoistablesMarker | EntityFieldMarkersContainer>(
			(acc, addition) => {
