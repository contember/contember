...
const BoardQualifiedDynamic = Component<BoardQualifiedDynamicProps>(
	({ entities, orderBy, limit, offset, columns, columnsSortableBy, discriminationField, sortableBy, sortScope, children }) => {
...
const RelativeDynamicBoard = Component<BoardRelativeDynamicProps>(
	({ field, orderBy, limit, offset, columns, columnsSortableBy, discriminationField, sortableBy, sortScope, children }) => {
...
const BoardQualifiedStatic = Component<BoardQualifiedStaticProps>(
	({ entities, orderBy, limit, offset, columns, discriminationField, sortableBy, sortScope, children }) => {
		const itemsAccessor = useEntityListSubTree({ entities, orderBy, limit, offset })
...
const RelativeStaticBoard = Component<BoardRelativeStaticProps>(
	({ field, orderBy, limit, offset, columns, discriminationField, sortableBy, sortScope, children }) => {
		const itemsAccessor = useEntityList({ field, orderBy, limit, offset })
		const [data, methods] = useStaticBoard({
			itemEntities: itemsAccessor,
			columns,
