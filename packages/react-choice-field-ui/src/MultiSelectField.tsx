import { Component, EntityAccessor, useLabelMiddleware } from '@contember/react-binding'
import {
	FieldContainer,
	FieldContainerProps,
	getPortalRoot,
...
export interface MultiSelectFieldInnerPublicProps extends Omit<FieldContainerProps, 'children' | 'errors'> {
	placeholder?: string
