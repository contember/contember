 ...
 *
 * ### Props
 * - **`fields`**: Specifies the fields to include in the export. Defaults to the fields in the data view's global configuration.
 * - **`children`**: The button element for the export trigger.
 * - **`baseName`**: The base name for the exported file. Defaults to `<entityName>-<current-date>`.
 * - **`exportFactory`**: A factory for generating the exported data. Defaults to a CSV export factory.
 *
 * ### Behavior
