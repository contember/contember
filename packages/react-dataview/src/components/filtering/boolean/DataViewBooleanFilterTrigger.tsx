...
export type DataViewBooleanFilterTriggerAttributes = {
	['data-active']?: ''
...
export type DataViewBooleanFilterTriggerProps = {
	name?: string
	value: boolean
 ...
 *
 * ### Props
 * - **`value`**: Specifies the boolean value this button represents (e.g., typically one button for `true` and one for `false`).
