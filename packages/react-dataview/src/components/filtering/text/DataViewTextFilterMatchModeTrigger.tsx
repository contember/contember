 ...
 *
 * ### Props
 * - **`mode`**: Specifies the match mode for the text filter (matches, matchesExactly, startsWith, endsWith, 'doesNotMatch)
 * - **`children`**: The button element that triggers the match mode change.
