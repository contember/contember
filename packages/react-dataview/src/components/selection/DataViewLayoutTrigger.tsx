...
const SlotType = Slot as React.ForwardRefExoticComponent<
	...
	DataViewLayoutTriggerAttributes
>
 ...
 *
 * ### Props
 * - **`name`**: The name of the layout this trigger activates (e.g., "table" or "tiles").
 * - **`children`**: The button element for the layout trigger.
 *
