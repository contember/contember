...
export const [ActiveSlotPortalsContext, useActiveSlotPortalsContext] = createContext<ActiveSlotPortalsContextType>(
...
export const [TargetsRegistryContext, useTargetsRegistryContext] = createContext<SlotTargetsRegistryContextType>(
	'Layout.Slots.TargetsRegistryContext',
	{
...
export const [PortalsRegistryContext, usePortalsRegistryContext] = createContext<RenderToSlotPortalContextType>(
	'Layout.Slots.PortalsRegistryContext',
	{
		getTarget: undefined,
