...
export const TenantConfigView = ({ controller }: TenantConfigViewProps) => {
	...
	return (
		<div className="relative flex flex-col gap-6">
			...
			<ConfigSection title={dict.tenant.configView.panelAccess}>
				<SettingsTable
					rows={[
						['globalRoles', formatConfigValue(config.panel.globalRoles)],
						['projectRoles', formatConfigValue(config.panel.projectRoles)],
					]}
				/>
			</ConfigSection>
