...
const DimensionLabel = ({ label, dimensionValue }: { label: ReactNode; dimensionValue: ReactNode }) => (
	...
	<div className="flex mt-4 gap-4">
		<DimensionRenderer dimension={dimension} as={as}>
			<LabelMiddlewareProvider value={(label, environment) => {
				...
				return renderLabel
					? renderLabel(label, dimensionValue)
					: <DimensionLabel label={label} dimensionValue={dimensionValue} />
			}}>
				<HasOne field={field}>
