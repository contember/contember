...
export const editorButtons: ReactNode = (
	<>
		...
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 1, isNumbered: true }}>
			<Toggle className="relative">
				<Heading1Icon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		...
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 2, isNumbered: true }}>
			<Toggle className="relative">
				<Heading2Icon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		...
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 3, isNumbered: true }}>
			<Toggle className="relative">
				<Heading3Icon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		...
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 4, isNumbered: true }}>
			<Toggle className="relative">
				<Heading4Icon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		...
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 5, isNumbered: true }}>
			<Toggle className="relative">
				<Heading5Icon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 6, isNumbered: false }}>
			<Toggle>
				<Heading6Icon className="h-3 w-3" />
			</Toggle>
		</EditorElementTrigger>
		<EditorElementTrigger elementType={headingElementType} suchThat={{ level: 6, isNumbered: true }}>
			<Toggle className="relative">
				<Heading6Icon className="h-3 w-3" />
				<HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
		...
		<EditorElementTrigger elementType={paragraphElementType} suchThat={{ isNumbered: true }}>
			<Toggle className="relative">
				<PilcrowIcon className="h-3 w-3" /> <HashIcon className="h-2.5 w-2.5 absolute right-2 top-1" />
			</Toggle>
		</EditorElementTrigger>
