...
export const DropdownMenuSubTrigger = uic(DropdownMenuPrimitive.SubTrigger, {
	baseClass: 'flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden focus:bg-accent data-[state=open]:bg-accent',
	beforeChildren: (
...
export const DropdownMenuSubContent = uic(DropdownMenuPrimitive.SubContent, {
	baseClass: 'z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-200 bg-popover p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
...
export const DropdownMenuItem = uic(DropdownMenuPrimitive.Item, {
	baseClass: 'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
	displayName: 'DropdownMenuItem',
})

export const DropdownMenuCheckboxItem = uic(DropdownMenuPrimitive.CheckboxItem, {
	baseClass: 'relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-hidden transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
	beforeChildren: (
