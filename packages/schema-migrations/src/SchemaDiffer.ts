...
import {
	...
	MakeRelationDeprecatedDiffer,
	MakeRelationNotDeprecatedDiffer,
	MakeRelationNotNullDiffer,
	MakeRelationNullableDiffer,
	RemoveEntityDiffer,
	RemoveEnumDiffer,
	RemoveFieldDiffer,
	RemoveRelationAliasesDiffer,
	...
	UpdateEnumDiffer,
	UpdateFieldNameWithAliasDiffer,
	UpdateRelationAliasesDiffer,
	UpdateRelationDeprecationMessageDiffer,
...
export class SchemaDiffer {
	...
	diffSchemas(originalSchema: Schema, updatedSchema: Schema, {
		...
		const differs: Differ[] = [
			...
			new UpdateFieldNameWithAliasDiffer(),
			...
			new CreateRelationAliasesDiffer(),
			new UpdateRelationAliasesDiffer(),
			new RemoveRelationAliasesDiffer(),
			new MakeRelationDeprecatedDiffer(),
			new MakeRelationNotDeprecatedDiffer(),
			new UpdateRelationDeprecationMessageDiffer(),
