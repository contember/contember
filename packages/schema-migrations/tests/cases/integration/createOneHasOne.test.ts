...
describe('create one has one relation (site with settings)', () =>
	testMigrations({
		original: {},
		updated: {
	...
	ALTER TABLE "site"
		ADD "setting_id" uuid;
	ALTER TABLE "site"
		ADD FOREIGN KEY ("setting_id") REFERENCES "site_setting"("id") ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE;
	ALTER TABLE "site"
