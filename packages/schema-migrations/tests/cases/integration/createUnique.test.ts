...
describe('create unique (deferrable)', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('create unique (deferred)', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('create unique using decorator', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('create unique index with GIN method', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('create unique index with GiST method', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('create unique index with btree method and nulls not distinct', () =>
	testMigrations({
		original: createSchema({
			Author: class Author {
				email = c.stringColumn()
...
describe('change unique index method from gin to gist', () =>
	testMigrations({
...
describe('change from regular unique index to method-specific unique index', () =>
	testMigrations({
