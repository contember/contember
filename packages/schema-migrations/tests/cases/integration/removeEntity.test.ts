...
describe('remove junction table, when both entities are removed', () =>
	testMigrations({
...
describe('remove junction table, when owning entity is removed', () =>
	testMigrations({
		original: createSchema(EntityWithManyHasManyOriginalSchema),
...
describe('remove junction table, when inverse entity is removed', () =>
	testMigrations({
		original: createSchema(EntityWithManyHasManyOriginalSchema),
...
describe('remove self-referencing relation', () =>
	testMigrations({
