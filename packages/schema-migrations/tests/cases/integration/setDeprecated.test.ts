...
describe('set deprecation on entity', () =>
	testMigrations({
...
describe('set deprecation on field', () =>
	testMigrations({
...
describe('update existing entity deprecation', () =>
	testMigrations({
...
describe('update existing field deprecation', () =>
	testMigrations({
...
describe('remove entity deprecation', () =>
	testMigrations({
...
describe('remove field deprecation', () =>
	testMigrations({
...
describe('set deprecation on relation field', () =>
	testMigrations({
...
describe('set deprecation on multiple entities and fields', () =>
	testMigrations({
...
describe('no changes when deprecations are the same', () =>
	testMigrations({
