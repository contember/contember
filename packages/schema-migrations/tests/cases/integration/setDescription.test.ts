...
describe('set description on entity', () =>
	testMigrations({
...
describe('set description on field', () =>
	testMigrations({
...
describe('update existing entity description', () =>
	testMigrations({
...
describe('update existing field description', () =>
	testMigrations({
...
describe('remove entity description', () =>
	testMigrations({
...
describe('remove field description', () =>
	testMigrations({
...
describe('set description on relation field', () =>
	testMigrations({
...
describe('set description on multiple entities and fields', () =>
	testMigrations({
...
describe('no changes when descriptions are the same', () =>
	testMigrations({
