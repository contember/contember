export type ValidationErrorCode =
	...
	| 'RETENTION_NAME_MISMATCH'
	| 'RETENTION_UNDEFINED_ENTITY'
	| 'RETENTION_UNDEFINED_FIELD'
	| 'RETENTION_INVALID_FIELD'
	| 'RETENTION_INVALID_INTERVAL'
	| 'RETENTION_INVALID_WHERE'
	| 'RETENTION_INVALID_SCHEDULE'
	| 'RETENTION_INVALID_LIMIT'
