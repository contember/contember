...
export const ContemberLogoImage = ({ withLabel }: ContemberLogoImage) => {
  ...
  return <svg
    className={classNames(
      `${prefix}contember-logo-image-symbol`,
      withLabel && 'view-with-label',
    )}
